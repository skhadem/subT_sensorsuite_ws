...
if("FALSE" STREQUAL "TRUE")
  set(phidgets_imu_SOURCE_PREFIX /home/ohrad/ROS/subT_sensorsuite_ws/src/phidgets_drivers/phidgets_imu)
  set(phidgets_imu_DEVEL_PREFIX /home/ohrad/ROS/subT_sensorsuite_ws/devel)
  ...
  set(phidgets_imu_INSTALL_PREFIX /home/ohrad/ROS/subT_sensorsuite_ws/install)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  elseif(NOT "http://ros.org/wiki/phidgets_imu " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/phidgets_imu' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phidgets_imu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ohrad/ROS/subT_sensorsuite_ws/install/${idir}'.  ${_report}")
    endif()
...
set(depends "diagnostic_msgs;diagnostic_updater;nodelet;pluginlib;phidgets_api;roscpp;sensor_msgs;std_msgs;std_srvs;tf")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${phidgets_imu_dep}_FOUND)
      find_package(${phidgets_imu_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${phidgets_imu_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(phidgets_imu_INCLUDE_DIRS ${${phidgets_imu_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(phidgets_imu_LIBRARIES ${phidgets_imu_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${phidgets_imu_dep}_LIBRARIES})
  _list_append_deduplicate(phidgets_imu_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(phidgets_imu_LIBRARIES ${phidgets_imu_LIBRARIES})
