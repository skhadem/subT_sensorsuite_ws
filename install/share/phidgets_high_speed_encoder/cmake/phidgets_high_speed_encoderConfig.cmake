...
if("FALSE" STREQUAL "TRUE")
  set(phidgets_high_speed_encoder_SOURCE_PREFIX /home/ohrad/ROS/subT_sensorsuite_ws/src/phidgets_drivers/phidgets_high_speed_encoder)
  set(phidgets_high_speed_encoder_DEVEL_PREFIX /home/ohrad/ROS/subT_sensorsuite_ws/devel)
  ...
  set(phidgets_high_speed_encoder_INSTALL_PREFIX /home/ohrad/ROS/subT_sensorsuite_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Geoff Viola <geoffrey.viola@asirobots.com>, José-Luis Blanco Claraco <jlblanco@ual.es>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'phidgets_high_speed_encoder' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'phidgets_high_speed_encoder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ohrad/ROS/subT_sensorsuite_ws/install/${idir}'.  ${_report}")
    endif()
